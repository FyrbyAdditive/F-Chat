...
struct SystemPromptCompositionTests {
    ...
    /// Custom agent: basePromptOverride replaces the FyxLocal preamble at
    ...
    @Test func customBasePromptReplacesPreambleAndKeepsGuidance() {
        ...
        // The default preamble starts with "You are FyxLocal" — must NOT
        // be present in a custom-agent render.
        #expect(!rendered.contains("You are FyxLocal"))
