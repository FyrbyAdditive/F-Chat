...
/// bundled in FyxLocalCore, selecting the value for an explicit `PromptLanguage`.
///
...
///
/// Callers in FyxLocalProviders / FyxLocalTools cannot see FyxLocalCore's `Bundle.module`,
