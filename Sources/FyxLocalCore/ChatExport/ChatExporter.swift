...
public enum ChatExporter {
    ...
    public static func export(
        ...
        case .markdown, .plainText, .docx:
            if conversations.count == 1 {
                ...
                return ChatExportBundle(data: data, suggestedFilename: "FyxLocal export.zip", contentType: .zip)
            }
        }
    }
    ...
    /// Encode conversations as the native FyxLocal JSON array — same encoder
